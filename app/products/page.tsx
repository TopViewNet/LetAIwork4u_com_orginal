...
const products = [
  ...
  {
    id: "beamobilesync",
    href: "/platforms/beamobilesync",
    statusKey: "products.status.development",
    icon: FileText,
    image: "/brand/logo01.jpeg",
    accent: "from-blue-200 via-cyan-300 to-indigo-700",
    featured: true,
    features: ["products.beamobilesync.feature.1", "products.beamobilesync.feature.2", "products.beamobilesync.feature.3"],
  },
  {
    id: "beavoicesupport",
    ...
    featured: false,
    features: [
      "products.beavoicesupport.feature.1",
      "products.beavoicesupport.feature.2",
      "products.beavoicesupport.feature.3",
    ],
  },
  {

    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-slate-950/85 backdrop-blur-xl">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link
            href="/contact"
            className="hidden items-center justify-center rounded-md border border-white/80 bg-white px-3 py-2 text-sm font-semibold text-slate-950 shadow-sm shadow-cyan-950/30 transition hover:bg-slate-100 xl:inline-flex"
          >
            {t("nav.getStarted")}
          </Link>
          <button

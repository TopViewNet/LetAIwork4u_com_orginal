...
export const platforms: Platform[] = [
  {
    ...
    capabilities: [
      "Digitale Akten",
      "DMS und Dokumentenfluss",
      "Fristen und Zeiterfassung",
      "beA Sync App-Modul",
    ...
    roadmap: [
      ...
      "beA Sync App-Prototyp als Produktmodul einordnen",
      "Outlook als Kommunikationskanal ergaenzen",
      "Kanzlei-Rollenmodell und Adminportal",
    ],
  },
  {
    slug: "bea4outlook",
